...
[Learn more about this workspace setup and its capabilities](https://nx.dev/getting-started/tutorials/angular-standalone-tutorial?utm_source=nx_project&amp;utm_medium=readme&amp;utm_campaign=nx_projects)
or run `npx nx graph` to visually explore what was created. Now, let's get you up to speed!

## Finish your CI setup

[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/9xGdHkpsi4)
...
```sh
npx nx serve tevet-troc-client
```

To create a production bundle:

```sh
npx nx build tevet-troc-client
```

To see all available targets to run for a project, run:

```sh
npx nx show project tevet-troc-client
```
